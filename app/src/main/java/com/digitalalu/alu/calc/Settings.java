...
/** All deduction values + stock settings (everything in INCH) */
public class Settings {
    ...
    /* ---------------- ZED ---------------- */
    public double z_dw  = 1.20;    // sutter width deduct per unit (30mm)
    public double z_dh  = 2.36;    // sutter height deduct
    public double z_dm  = 2.43;    // muliya height deduct
    public double z_dg  = 4.18;    // glass deduct
    public double z_rpDed = 0.20;  // rp length = W - this

    /* ---------------- DOMAL ---------------- */
    public double d_dw  = 0.00;      // (unused for width now)
    public double d_trackAdd = 2.00; // 3+ track: (W + add*(q-2)) / q
    public double d_dh  = 2.87;    // sutter height deduct
    public double d_dm  = 2.30;    // RT height deduct
    public double d_dg  = 4.00;    // glass deduct
    public double d_rpDed = 1.00;  // rp length = W - this
